# Model Training
Different JTVAE models can be trained to use in SampleDock pipeline. The following instruction is copied from https://github.com/wengong-jin/icml18-jtnn/tree/master/fast_molvae for training JTVAE models.
